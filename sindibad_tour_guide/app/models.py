...
class Categories(models.Model):
    ...
    icon = models.ImageField(db_column='Icon', max_length=300, blank=True, null=True,upload_to="images/")  # Field name made lowercase.
...
class Countries(models.Model):
    ...
    name = models.CharField(db_column='Name', max_length=100, blank=True, null=True)  # Field name made lowercase.
    description = models.CharField(db_column='Description', max_length=300, blank=True, null=True)  # Field name made lowercase.
    profile = models.ImageField(db_column='Profile', max_length=300, blank=True, null=True,upload_to="images/")  # Field name made lowercase.
    active = models.IntegerField(db_column='Active', blank=True, null=True)  # Field name made lowercase.
    created_by = models.CharField(db_column='Created_by', max_length=100, blank=True, null=True)  # Field name made lowercase.
    created_date = models.DateTimeField(db_column='Created_date', blank=True, null=True)  # Field name made lowercase.
    updated_by = models.CharField(db_column='Updated_by', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class Roles(models.Model):
    ...
    sympol = models.CharField(db_column='Sympol', max_length=45, blank=True, null=True)  # Field name made lowercase.
...
class SubCategories(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    city = models.ForeignKey(Cities, models.DO_NOTHING, db_column='City_id', blank=True, null=True)  # Field name made lowercase.
    cat = models.ForeignKey(Categories, models.DO_NOTHING, db_column='Cat_id', blank=True, null=True)  # Field name made lowercase.
    ...
    sub_cat_image = models.ImageField(db_column='Sub_cat_image', max_length=300, blank=True, null=True,upload_to="images/")  # Field name made lowercase.
    ...
    direction = models.CharField(db_column='Direction', max_length=200, blank=True, null=True)  # Field name made lowercase.
    active = models.IntegerField(db_column='Active', blank=True, null=True)  # Field name made lowercase.
    created_by = models.CharField(db_column='Created_by', max_length=100, blank=True, null=True)  # Field name made lowercase.
    created_date = models.DateTimeField(db_column='Created_date', blank=True, null=True)  # Field name made lowercase.
    updated_by = models.CharField(db_column='Updated_by', max_length=100, blank=True, null=True)  # Field name made lowercase.
